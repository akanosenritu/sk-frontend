import {RegisteredStaffDraft, StaffsDict} from "../types/staffs"
import {v4} from "uuid"
import create from "zustand"

export const getStaffCounts = (staffs: RegisteredStaffDraft[]) => {
  let male = 0
  let female = 0
...
export const createSampleStaffData = (dataArray: {president: string}[]): RegisteredStaffDraft[] => {
  return dataArray.map(obj => ({name: obj.president, gender: "male", uuid: v4()}))
}
export const sampleStaffDataArray = [
  ...
  {"number":45,"president":"Donald J. Trump","birth_year":1946,"death_year":null,"took_office":"2017-01-20","left_office":"2021-01-20","party":"Republican"},
  {"number":46,"president":"Joseph 'Joe' Biden","birth_year":1942,"death_year":null,"took_office":"2021-01-20","left_office":null,"party":"Democratic"}
]

export const sampleStaffData: RegisteredStaffDraft[] = createSampleStaffData(sampleStaffDataArray)

export const createStaffsDict = (staffs: RegisteredStaffDraft[]) => {
